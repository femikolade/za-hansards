...
<p>It has been decided to increase the pay of national servicemen with effect from 1 April 1979 from the present 33<unk>% to 75% of the minimum notch of the pay of the corresponding ranks in the Permanent Force. This means that a national serviceman will in future receive R3,43 per day, or about R100 per month instead of R1,52 per day or R45 per month, as is the case at present. The pay of a national service corporal will increase from R2,85 to R6,41 per day&#x2014;R192 per month.</p>
